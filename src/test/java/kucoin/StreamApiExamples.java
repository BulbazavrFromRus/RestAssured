...
public class StreamApiExamples {
    ...
    public void checkCrypto(){
        ...
        //we use allMatch() when we check all data and if at least one would be wrong this method returns false
    ...
    public void sortHighToLow(){
     ...
     Assert.assertEquals(top10.get(0).getSymbol(), "MNDE-USDT");
